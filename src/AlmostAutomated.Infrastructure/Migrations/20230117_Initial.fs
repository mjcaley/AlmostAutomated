    ...
    type Initial =
        ...
        override this.Up() =
            this.Create.Table("Template")
                ...
                |> ignore
            this.Create.Table("TemplateDetails")
                .WithColumn("Id").AsInt64().PrimaryKey().Identity()
                .WithColumn("TemplateId").AsInt64().ForeignKey("Template", "Id")
                .WithColumn("Title").AsString()
                .WithColumn("Description").AsString()
                .WithColumn("ValidFrom").AsDateTime().WithDefault(SystemMethods.CurrentUTCDateTime)
