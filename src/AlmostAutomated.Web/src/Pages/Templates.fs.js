...
export function Templates() {
    ...
    const elms_3 = ofArray([(elms = singleton(createElement("a", {
        className: "button",
        children: RouterModule_encodeParts(singleton("/templates/new"), 2),
    })), createElement("div", {
        className: "container",
        children: Interop_reactApi.Children.toArray(Array.from(elms)),
    })), (elms_2 = singleton((elms_1 = map((template) => createElement(TemplateComponent, template), templates), createElement("div", {
        className: "tile",
